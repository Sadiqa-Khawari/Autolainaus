...
"background-color: rgb(140, 51, 85);")
        ...
        self.keyPictureLabel.setPixmap(QPixmap(u"uiPicture/keys.png"))
        ...
        self.lenderPictureLabel.setPixmap(QPixmap(u":/UiPicture/uiPicture/Teacher.png"))
...
"background-color: rgb(140, 51, 85);")
        ...
        self.calendarLabel.setGeometry(QRect(20, 480, 31, 51))
        self.calendarLabel.setPixmap(QPixmap(u"uiPicture/calendar.png"))
        ...
        self.clockLabel.setPixmap(QPixmap(u":/UiPicture/uiPicture/clock.png"))
...
"color: rgb(255, 255, 255);")
        ...
        self.lendeNameLabel = QLabel(self.centralwidget)
        self.lendeNameLabel.setObjectName(u"lendeNameLabel")
        self.lendeNameLabel.setGeometry(QRect(60, 380, 151, 31))
        font4 = QFont()
        font4.setPointSize(16)
        self.lendeNameLabel.setFont(font4)
        self.lendeNameLabel.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.carlnfoLabel = QLabel(self.centralwidget)
        self.carlnfoLabel.setObjectName(u"carlnfoLabel")
        self.carlnfoLabel.setGeometry(QRect(370, 380, 171, 31))
        self.carlnfoLabel.setFont(font4)
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lendeNameLabel.setText(QCoreApplication.translate("MainWindow", u"Lainajan nimi", None))
        self.carlnfoLabel.setText(QCoreApplication.translate("MainWindow", u"Merkki auto", None))
