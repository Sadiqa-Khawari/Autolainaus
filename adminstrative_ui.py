...
"color: rgb(255, 255, 255);")
        self.tableWidget_2 = QTableWidget(self.groupTab)
        ...
        self.storedGroupsLabel.setGeometry(QRect(30, 100, 101, 16))
        self.widget2 = QWidget(self.groupTab)
        self.widget2.setObjectName(u"widget2")
        self.widget2.setGeometry(QRect(120, 20, 169, 56))
        self.verticalLayout = QVBoxLayout(self.widget2)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.groupNameLineEdit = QLineEdit(self.widget2)
        ...
        self.responsiblePersonLineEdit = QLineEdit(self.widget2)
        ...
        self.responsiblePersonLabel = QLabel(self.widget3)
...
#endif // QT_CONFIG(shortcut)
        self.actionVaihda_salasana.setText(QCoreApplication.translate("MainWindow", u"Salasana...", None))
