...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QRect(20, 0, 783, 551))
...
"color: rgb(255, 255, 255);")
        ...
        self.pushButton.setGeometry(QRect(330, 70, 75, 23))
        self.pushButton.setStyleSheet(u"background-color: rgb(0, 85, 255);")
        self.grouptableWidget_2 = QTableWidget(self.tab)
        if (self.grouptableWidget_2.columnCount() < 2):
            self.grouptableWidget_2.setColumnCount(2)
        if (self.grouptableWidget_2.rowCount() < 10):
            self.grouptableWidget_2.setRowCount(10)
        self.grouptableWidget_2.setObjectName(u"grouptableWidget_2")
        self.grouptableWidget_2.setGeometry(QRect(10, 150, 381, 181))
        self.grouptableWidget_2.setRowCount(10)
        self.grouptableWidget_2.setColumnCount(2)
        ...
        self.layoutWidget4.setGeometry(QRect(10, 30, 101, 51))
        ...
        self.responsiblePersonLabel = QLabel(self.layoutWidget4)
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Talennetut ryhm\u00e4t", None))
