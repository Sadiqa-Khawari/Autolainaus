...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QRect(20, 0, 641, 631))
        ...
        self.registeredPersonsTableWidget.setGeometry(QRect(10, 220, 601, 351))
...
"color: rgb(255, 255, 255);")
        ...
        self.layoutWidget.setGeometry(QRect(130, 10, 171, 184))
        ...
        self.groupComboBox.setLocale(QLocale(QLocale.Finnish, QLocale.Finland))
        self.groupComboBox.setEditable(False)
        ...
        self.layoutWidget1.setGeometry(QRect(20, 10, 101, 181))
        ...
        self.registeredPersonsLabel = QLabel(self.layoutWidget1)
        self.registeredPersonsLabel.setObjectName(u"registeredPersonsLabel")

        self.studentLabelsVerticalLayout.addWidget(self.registeredPersonsLabel)
...
"color: rgb(255, 255, 255);")
        ...
        self.saveGroupPushButton.setGeometry(QRect(330, 70, 75, 23))
        self.saveGroupPushButton.setStyleSheet(u"background-color: rgb(0, 85, 255);")
        self.saveGroupsTableWidget = QTableWidget(self.groupsTab)
        ...
        self.saveGroupsTableWidget.setGeometry(QRect(10, 150, 391, 181))
        self.saveGroupsTableWidget.setRowCount(10)
        self.saveGroupsTableWidget.setColumnCount(2)
        self.saveGroupLabel = QLabel(self.groupsTab)
        self.saveGroupLabel.setObjectName(u"saveGroupLabel")
        self.saveGroupLabel.setGeometry(QRect(20, 120, 111, 21))
        ...
        self.layoutWidget4.setGeometry(QRect(10, 30, 101, 61))
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.registeredPersonsLabel.setText(QCoreApplication.translate("MainWindow", u"S\u00e4hk\u00f6posti", None))
        ...
        self.saveGroupLabel.setText(QCoreApplication.translate("MainWindow", u"Talennetut ryhm\u00e4t", None))
        ...
        self.beginingDateEdit.setDisplayFormat(QCoreApplication.translate("MainWindow", u"dd.MM.yyyy", None))
        ...
        self.endingDateEdit.setDisplayFormat(QCoreApplication.translate("MainWindow", u"dd.MM.yyyy", None))
