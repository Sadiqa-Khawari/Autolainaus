...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lenderLineEdit.setGeometry(QRect(10, 80, 151, 31))
        font = QFont()
